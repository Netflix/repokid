...
Role selection can pe specified per individual account or globally.
To activate this filter put `"repokid.filters.blocklist:BlocklistFilter"`in the section `active_filters` of the config file.
